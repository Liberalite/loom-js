...
export declare class User extends Entity {
    ...
    static createMetamaskUser(web3: Web3, plasmaAddress: string, dappchainEndpoint: string, eventsEndpoint: string, startBlock?: BN, chainId?: string): User;
    static createOfflineUser(privateKey: string, endpoint: string, plasmaAddress: string, dappchainEndpoint: string, eventsEndpoint: string, dbPath?: string, startBlock?: BN, chainId?: string): User;
    static createUser(wallet: ethers.Signer, plasmaAddress: string, dappchainEndpoint: string, eventsEndpoint: string, dbPath?: string, startBlock?: BN, chainId?: string): User;
