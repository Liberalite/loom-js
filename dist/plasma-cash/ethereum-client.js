...
var EthereumPlasmaClient = /** @class */ (function () {
    ...
    EthereumPlasmaClient.prototype.withdrawAsync = function (params) {
        var slot = params.slot, from = params.from, gas = params.gas, gasPrice = params.gasPrice;
    ...
    EthereumPlasmaClient.prototype.withdrawBondsAsync = function (params) {
        var from = params.from, gas = params.gas, gasPrice = params.gasPrice;
    ...
    EthereumPlasmaClient.prototype.challengeBeforeAsync = function (params) {
        ...
        return this._plasmaContract.challengeBefore('0x' + slot.toString(16), prevTxBytes, challengingTxBytes, prevTx ? prevTx.proof : '0x', challengingTx.proof, challengingTx.sig, [prevBlk, '0x' + challengingBlockNum.toString(16)], { value: bond, gasLimit: gas });
    };
    /**
