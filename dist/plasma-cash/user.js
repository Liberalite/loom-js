...
var ERC721_ABI = ['function safeTransferFrom(address _from, address _to, uint256 _tokenId)'];
...
var User = /** @class */ (function (_super) {
    ...
    User.createMetamaskUser = function (web3, plasmaAddress, dappchainEndpoint, eventsEndpoint, startBlock, chainId) {
        var provider = new ethers_1.ethers.providers.Web3Provider(web3.currentProvider);
        var signer = provider.getSigner();
        return this.createUser(signer, plasmaAddress, dappchainEndpoint, eventsEndpoint, undefined, startBlock, chainId);
    };
    User.createOfflineUser = function (privateKey, endpoint, plasmaAddress, dappchainEndpoint, eventsEndpoint, dbPath, startBlock, chainId) {
        var provider = new ethers_1.ethers.providers.JsonRpcProvider(endpoint);
    ...
    User.createUser = function (wallet, plasmaAddress, dappchainEndpoint, eventsEndpoint, dbPath, startBlock, chainId) {
        var database = new __1.PlasmaDB(dbPath);
        var ethPlasmaClient = new __1.EthereumPlasmaClient(wallet, plasmaAddress, eventsEndpoint);
    ...
    User.prototype.depositERC20Async = function (amount, address) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var token, currentApproval, currentBlock, tx, coin;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        token = new ethers_1.ethers.Contract(address, ERC20, this.ethers);
                        return [4 /*yield*/, token.allowance(this.ethAddress, this.plasmaCashContract.address)
                            // amount - approved
                        ];
                    case 1:
                        currentApproval = _a.sent();
                        if (!amount.gt(currentApproval)) return [3 /*break*/, 3];
                        return [4 /*yield*/, token.approve(this.plasmaCashContract._address, amount.sub(currentApproval).toString())];
                    case 2:
                        _a.sent();
                    ...
                    case 4:
                        currentBlock = _a.sent();
                        return [4 /*yield*/, this.plasmaCashContract.depositERC20(amount, address)];
                    case 5:
                        tx = _a.sent();
                        return [4 /*yield*/, this.getCoinFromTxAsync(tx.transactionHash)];
                    case 6:
                        coin = _a.sent();
                        return [4 /*yield*/, this.pollForBlockChange(currentBlock, 20, 2000)];
                    case 7:
